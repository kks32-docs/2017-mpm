...
\begin{keyword}
MPM; Granuar dynamics; Tranient flows; Continuum; Discrete Element Modelling;
...
\begin{figure}[tbhp]
  ...
  \begin{subfigure}[t]{0.75\textwidth}
    \centering
    \includegraphics[width=0.95\textwidth]{figs/MPM_Initial_PIC_Slope}
  ...
  \begin{subfigure}[t]{0.95\textwidth}
    \centering
    \includegraphics[width=0.95\textwidth]{figs/MPM_Stress_Slope}
...
\begin{figure}[tbhp]
  ...
  \begin{subfigure}[t]{0.475\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/Sxy_vs_Syy_Slope}
    \caption{Evaluation of the critical state friction angle.}
    \label{fig:Sxy_vs_Syy_Slope}
  \end{subfigure}
  %
  \begin{subfigure}[t]{0.475\textwidth}
    \includegraphics[width=0.95\textwidth]{figs/mu_vs_I}
